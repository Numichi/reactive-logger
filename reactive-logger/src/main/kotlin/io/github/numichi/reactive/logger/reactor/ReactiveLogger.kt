...
open class ReactiveLogger(
    ...
    override fun debug(marker: Marker?, format: String?, vararg arguments: Any?): Mono<Void> = wrap { logger.debug(marker, format, *arguments) }
    ...
    override fun info(marker: Marker?, format: String?, vararg arguments: Any?): Mono<Void> = wrap { logger.info(marker, format, *arguments) }
    ...
    override fun warn(marker: Marker?, format: String?, vararg arguments: Any?): Mono<Void> = wrap { logger.warn(marker, format, *arguments) }
    ...
    override fun error(marker: Marker?, format: String?, vararg arguments: Any?): Mono<Void> = wrap { logger.error(marker, format, *arguments) }
