...
interface RKLogger : RSnapshot {
    ...
    fun trace(throwable: Throwable?, message: () -> Any?): Mono<Void>
    fun debug(throwable: Throwable?, message: () -> Any?): Mono<Void>
    fun info(throwable: Throwable?, message: () -> Any?): Mono<Void>
    fun warn(throwable: Throwable?, message: () -> Any?): Mono<Void>
    fun error(throwable: Throwable?, message: () -> Any?): Mono<Void>

    fun trace(throwable: Throwable?, marker: Marker?, message: () -> Any?): Mono<Void>
    fun debug(throwable: Throwable?, marker: Marker?, message: () -> Any?): Mono<Void>
    fun info(throwable: Throwable?, marker: Marker?, message: () -> Any?): Mono<Void>
    fun warn(throwable: Throwable?, marker: Marker?, message: () -> Any?): Mono<Void>
    fun error(throwable: Throwable?, marker: Marker?, message: () -> Any?): Mono<Void>

    fun atTrace(marker: Marker?, block: KLoggingEventBuilder.() -> Unit): Mono<Void>
    fun atTrace(block: KLoggingEventBuilder.() -> Unit): Mono<Void>
    fun atDebug(marker: Marker?, block: KLoggingEventBuilder.() -> Unit): Mono<Void>
    fun atDebug(block: KLoggingEventBuilder.() -> Unit): Mono<Void>
    fun atInfo(marker: Marker?, block: KLoggingEventBuilder.() -> Unit): Mono<Void>
    fun atInfo(block: KLoggingEventBuilder.() -> Unit): Mono<Void>
    fun atWarn(marker: Marker?, block: KLoggingEventBuilder.() -> Unit): Mono<Void>
    fun atWarn(block: KLoggingEventBuilder.() -> Unit): Mono<Void>
    fun atError(marker: Marker?, block: KLoggingEventBuilder.() -> Unit): Mono<Void>
    fun atError(block: KLoggingEventBuilder.() -> Unit): Mono<Void>
    fun at(level: Level, marker: Marker? = null, block: KLoggingEventBuilder.() -> Unit): Mono<Void>
