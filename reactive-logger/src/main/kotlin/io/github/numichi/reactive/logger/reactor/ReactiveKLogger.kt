...
class ReactiveKLogger(
    ...
    override fun trace(
        throwable: Throwable?,
        message: () -> Any?,
    ): Mono<Void> = wrap { logger.trace(throwable, message) }
    ...
    override fun trace(
        ...
        wrap {
            logger.trace(throwable, marker, message)
        }
    ...
    override fun debug(
        throwable: Throwable?,
        message: () -> Any?,
    ): Mono<Void> = wrap { logger.debug(throwable, message) }
    ...
    override fun debug(
        ...
        wrap {
            logger.debug(throwable, marker, message)
        }
    ...
    override fun info(
        throwable: Throwable?,
        message: () -> Any?,
    ): Mono<Void> = wrap { logger.info(throwable, message) }
    ...
    override fun info(
        ...
        wrap {
            logger.info(throwable, marker, message)
        }
    ...
    override fun warn(
        throwable: Throwable?,
        message: () -> Any?,
    ): Mono<Void> = wrap { logger.warn(throwable, message) }
    ...
    override fun warn(
        ...
        wrap {
            logger.warn(throwable, marker, message)
        }
    ...
    override fun isLoggingEnabledFor(
        level: Level,
        marker: Marker?,
    ): Boolean = logger.isLoggingEnabledFor(level, marker)
    ...
    override fun error(
        throwable: Throwable?,
        message: () -> Any?,
    ): Mono<Void> = wrap { logger.error(throwable, message) }
    ...
    override fun error(
        ...
        wrap {
            logger.error(throwable, marker, message)
        }

    override fun atTrace(
        marker: Marker?,
        block: KLoggingEventBuilder.() -> Unit,
    ): Mono<Void> = wrap { logger.atTrace(marker, block) }

    override fun atTrace(block: KLoggingEventBuilder.() -> Unit): Mono<Void> = wrap { logger.atTrace(block) }

    override fun atDebug(
        marker: Marker?,
        block: KLoggingEventBuilder.() -> Unit,
    ): Mono<Void> = wrap { logger.atDebug(marker, block) }
    ...
    override fun atInfo(
        marker: Marker?,
        block: KLoggingEventBuilder.() -> Unit,
    ): Mono<Void> = wrap { logger.atInfo(marker, block) }
    ...
    override fun atWarn(
        marker: Marker?,
        block: KLoggingEventBuilder.() -> Unit,
    ): Mono<Void> = wrap { logger.atWarn(marker, block) }

    override fun atWarn(block: KLoggingEventBuilder.() -> Unit): Mono<Void> = wrap { logger.atWarn(block) }

    override fun atError(
        marker: Marker?,
        block: KLoggingEventBuilder.() -> Unit,
    ): Mono<Void> = wrap { logger.atError(marker, block) }
